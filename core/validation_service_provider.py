...
class ValidationServiceInterface(Protocol):
    ...
    def validate_batch(self, triples: list[dict[str, Any]]) -> list[Any]:  # list[ValidationResult]
...
class ValidationServiceProvider:
    ...
    def register_type_inference_service(self, service: TypeInferenceServiceInterface) -> None:
    ...
    def get_service_status(self) -> dict[str, Any]:
        ...
        with self._lock:
            return {
                ...
                "validation_service_type": type(self._validation_service).__name__ if self._validation_service else None,
                "type_inference_service_registered": self._type_inference_service is not None,
                "type_inference_service_type": type(self._type_inference_service).__name__ if self._type_inference_service else None,
