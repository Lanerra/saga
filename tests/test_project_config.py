...
construct_configuration: Callable[..., NarrativeProjectConfig] = NarrativeProjectConfig
...
class TestValidCreation:
    ...
    def test_all_required_fields(self, valid_config_data: dict[str, object]) -> None:
        """A config with all required fields is created with matching values."""
        config = construct_configuration(**valid_config_data)
    ...
    def test_optional_fields_have_correct_defaults(self, valid_config_data: dict[str, object]) -> None:
    ...
    def test_optional_fields_accept_values(self, valid_config_data: dict[str, object]) -> None:
...
class TestMissingRequiredFields:
    ...
    def test_missing_required_field(self, valid_config_data: dict[str, object], field: str) -> None:
        """Each required field must be present."""
        del valid_config_data[field]

        with pytest.raises(ValidationError) as exception_info:
            construct_configuration(**valid_config_data)
...
class TestExtraFieldForbidden:
    ...
    def test_extra_field_raises_validation_error(self, valid_config_data: dict[str, object]) -> None:
...
class TestEmptyStringRejected:
    ...
    def test_empty_string_raises_validation_error(self, valid_config_data: dict[str, object], field: str) -> None:
...
class TestTotalChaptersConstraint:
    ...
    def test_zero_chapters_raises_validation_error(self, valid_config_data: dict[str, object]) -> None:
    ...
    def test_negative_chapters_raises_validation_error(self, valid_config_data: dict[str, object]) -> None:
    ...
    def test_one_chapter_is_valid(self, valid_config_data: dict[str, object]) -> None:
...
class TestStrictTypeCoercion:
    ...
    def test_integer_for_string_field_raises_validation_error(self, valid_config_data: dict[str, object]) -> None:
    ...
    def test_float_for_integer_field_raises_validation_error(self, valid_config_data: dict[str, object]) -> None:
    ...
    def test_string_for_integer_field_raises_validation_error(self, valid_config_data: dict[str, object]) -> None:
    ...
    def test_boolean_for_string_field_raises_validation_error(self, valid_config_data: dict[str, object]) -> None:
...
class TestModelRoundtrip:
    ...
    def test_dump_and_validate_roundtrip(self, valid_config_data: dict[str, object]) -> None:
        """Serializing then deserializing produces an equal model instance."""
        original = construct_configuration(**valid_config_data)
    ...
    def test_dump_contains_all_fields(self, valid_config_data: dict[str, object]) -> None:
    ...
    def test_roundtrip_with_optional_fields_populated(self) -> None:
        ...
        original = construct_configuration(**data)
