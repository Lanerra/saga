...
async def test_extraction_subgraph():
    ...
    state["draft_text"] = "Elara walked into the Sunken Library. She found the Starfall Map."
    ...
    mock_rel_response = '{"kg_triples": ["Character:Elara | LOCATED_IN | Location:Sunken Library"]}'
