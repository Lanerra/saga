...
class TestSafeStringExtract:
    ...
    def test_safe_string_extract_from_empty_string(self) -> None:
        """Test extracting string from empty string."""
        result = Neo4jExtractor.safe_string_extract("")
        assert result == ""

    def test_safe_string_extract_from_bool(self) -> None:
        """Test extracting string from boolean value."""
        result = Neo4jExtractor.safe_string_extract(True)
        assert result == "True"

    def test_safe_string_extract_from_float(self) -> None:
...
class TestExtractCoreFieldsFromNode:
    ...
    def test_extract_core_fields_from_dict(self) -> None:
    ...
    def test_extract_core_fields_from_neo4j_node(self) -> None:
    ...
    def test_extract_core_fields_empty_result(self) -> None:
    ...
    def test_extract_core_fields_with_empty_core_set(self) -> None:
    ...
    def test_extract_core_fields_with_extra_fields_only(self) -> None:
    ...
    def test_extract_core_fields_with_none_values(self) -> None:
    ...
    def test_extract_core_fields_with_complex_values(self) -> None:
