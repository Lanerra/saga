...
async def test_bootstrap_world_with_empty_elements():
    ...
    mock_name_responses = [
        ('{"name": "New York City"}', {"prompt_tokens": 10, "completion_tokens": 10, "total_tokens": 20}),
        ('{"name": "Medieval Society"}', {"prompt_tokens": 10, "completion_tokens": 10, "total_tokens": 20}),
        ('{"name": "Magic System"}', {"prompt_tokens": 10, "completion_tokens": 10, "total_tokens": 20}),
        ('{"name": "Ancient Lore"}', {"prompt_tokens": 10, "completion_tokens": 10, "total_tokens": 20}),
        ('{"name": "Ancient History"}', {"prompt_tokens": 10, "completion_tokens": 10, "total_tokens": 20}),
        ('{"name": "Rebel Faction"}', {"prompt_tokens": 10, "completion_tokens": 10, "total_tokens": 20}),
    ]
    
    mock_description_responses = [
        ('{"description": "A bustling metropolis in space."}', {"prompt_tokens": 10, "completion_tokens": 10, "total_tokens": 20}),
        ('{"description": "A society structured around feudal principles."}', {"prompt_tokens": 10, "completion_tokens": 10, "total_tokens": 20}),
        ('{"description": "A system of magic based on elemental forces."}', {"prompt_tokens": 10, "completion_tokens": 10, "total_tokens": 20}),
        ('{"description": "Legends of the ancient civilization."}', {"prompt_tokens": 10, "completion_tokens": 10, "total_tokens": 20}),
        ('{"description": "Events from the ancient past."}', {"prompt_tokens": 10, "completion_tokens": 10, "total_tokens": 20}),
        ('{"description": "A group opposing the current government."}', {"prompt_tokens": 10, "completion_tokens": 10, "total_tokens": 20}),
    ]
    ...
    with patch(
        ...
        assert result_world["locations"]["New York City"].properties.get("description") == "A bustling metropolis in space."
        
        assert "society" in result_world
        assert "Medieval Society" in result_world["society"]
        assert result_world["society"]["Medieval Society"].properties.get("description") == "A society structured around feudal principles."
        
        assert "systems" in result_world
        assert "Magic System" in result_world["systems"]
        assert result_world["systems"]["Magic System"].properties.get("description") == "A system of magic based on elemental forces."
        
        assert "lore" in result_world
        assert "Ancient Lore" in result_world["lore"]
        assert result_world["lore"]["Ancient Lore"].properties.get("description") == "Legends of the ancient civilization."
        
        assert "history" in result_world
        assert "Ancient History" in result_world["history"]
        assert result_world["history"]["Ancient History"].properties.get("description") == "Events from the ancient past."
        
        assert "factions" in result_world
        assert "Rebel Faction" in result_world["factions"]
        assert result_world["factions"]["Rebel Faction"].properties.get("description") == "A group opposing the current government."
...
async def test_bootstrap_world_overview_description():
    ...
    with patch(
        ...
        assert result_world["_overview_"]["_overview_"].properties.get("description") == "A detailed overview of the world setting."
