...
class NativeCypherBuilder:
    ...
    @staticmethod
    def character_fetch_cypher(filters: dict[str, Any] = None) -> tuple[str, dict[str, Any]]:
        """
    ...
    @staticmethod
    def world_item_fetch_cypher(filters: dict[str, Any] = None) -> tuple[str, dict[str, Any]]:
        """
