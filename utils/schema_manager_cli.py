...
async def command_status():
    ...
    try:
        ...
        if schema_info and not schema_info.get('error'):
            ...
            print(f"  Total Relationship Types: {schema_info.get('total_relationship_types', 0)}")
...
async def main():
    ...
    init_parser.add_argument('--force', action='store_true', help='Force refresh of cached data')
