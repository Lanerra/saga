...
DUPLICATE_PREVENTION_SIMILARITY_THRESHOLD = (
    settings.DUPLICATE_PREVENTION_SIMILARITY_THRESHOLD
)
DUPLICATE_PREVENTION_CHARACTER_ENABLED = (
    settings.DUPLICATE_PREVENTION_CHARACTER_ENABLED
)
DUPLICATE_PREVENTION_WORLD_ITEM_ENABLED = (
    settings.DUPLICATE_PREVENTION_WORLD_ITEM_ENABLED
)
ENABLE_PHASE2_DEDUPLICATION = settings.ENABLE_PHASE2_DEDUPLICATION
PHASE2_NAME_SIMILARITY_THRESHOLD = settings.PHASE2_NAME_SIMILARITY_THRESHOLD
PHASE2_RELATIONSHIP_SIMILARITY_THRESHOLD = (
    settings.PHASE2_RELATIONSHIP_SIMILARITY_THRESHOLD
)
