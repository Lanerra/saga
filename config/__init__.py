...
ENABLE_DUPLICATE_PREVENTION = settings_mod.ENABLE_DUPLICATE_PREVENTION
DUPLICATE_PREVENTION_SIMILARITY_THRESHOLD = (
    settings_mod.DUPLICATE_PREVENTION_SIMILARITY_THRESHOLD
)
DUPLICATE_PREVENTION_CHARACTER_ENABLED = (
    settings_mod.DUPLICATE_PREVENTION_CHARACTER_ENABLED
)
DUPLICATE_PREVENTION_WORLD_ITEM_ENABLED = (
    settings_mod.DUPLICATE_PREVENTION_WORLD_ITEM_ENABLED
)
ENABLE_PHASE2_DEDUPLICATION = settings_mod.ENABLE_PHASE2_DEDUPLICATION
PHASE2_NAME_SIMILARITY_THRESHOLD = settings_mod.PHASE2_NAME_SIMILARITY_THRESHOLD
PHASE2_RELATIONSHIP_SIMILARITY_THRESHOLD = (
    settings_mod.PHASE2_RELATIONSHIP_SIMILARITY_THRESHOLD
)
ENABLE_STATUS_IS_ALIAS = settings_mod.ENABLE_STATUS_IS_ALIAS
REVISION_EVALUATION_THRESHOLD = settings_mod.REVISION_EVALUATION_THRESHOLD

# Relationship Normalization Settings
ENABLE_RELATIONSHIP_NORMALIZATION = (
    settings.relationship_normalization.ENABLE_RELATIONSHIP_NORMALIZATION
)
REL_NORM_SIMILARITY_THRESHOLD = settings.relationship_normalization.SIMILARITY_THRESHOLD
REL_NORM_SIMILARITY_THRESHOLD_AMBIGUOUS_MIN = (
    settings.relationship_normalization.SIMILARITY_THRESHOLD_AMBIGUOUS_MIN
)
REL_NORM_MIN_USAGE_FOR_AUTHORITY = (
    settings.relationship_normalization.MIN_USAGE_FOR_AUTHORITY
)
REL_NORM_PRUNE_SINGLE_USE_AFTER_CHAPTERS = (
    settings.relationship_normalization.PRUNE_SINGLE_USE_AFTER_CHAPTERS
)
REL_NORM_MAX_VOCABULARY_SIZE = settings.relationship_normalization.MAX_VOCABULARY_SIZE
REL_NORM_MAX_EXAMPLES_PER_RELATIONSHIP = (
    settings.relationship_normalization.MAX_EXAMPLES_PER_RELATIONSHIP
)
REL_NORM_USE_LLM_DISAMBIGUATION = (
    settings.relationship_normalization.USE_LLM_DISAMBIGUATION
)
REL_NORM_NORMALIZE_CASE_VARIANTS = (
    settings.relationship_normalization.NORMALIZE_CASE_VARIANTS
)
REL_NORM_NORMALIZE_PUNCTUATION_VARIANTS = (
    settings.relationship_normalization.NORMALIZE_PUNCTUATION_VARIANTS
)
